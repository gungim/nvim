...
vim.g.symbols_outline = {
	...
	symbols = {
		...
		Component = { icon = icons.kind.Script, hl = 'Function' },
		Fragment = { icon = icons.kind.Script, hl = 'Constant' },
		TypeAlias = { icon =  icons.kind.Alias, hl = 'Type' },
		Parameter = { icon = icons.kind.TypeParameter, hl = 'Identifier' },
		StaticMethod = { icon = icons.kind.Function, hl = 'Function' },
