...
-- local config = require('user.gungim_theme.config')
...
require("github-theme").setup({
  ...
  overrides = function(c)
    return {
      ...
      PmenuSel = { fg = colors.background, bg = colors.background },
      WildMenu = { fg = colors.color7, bg = colors.background },
      CursorLineNr = { fg = colors.color16 },
      Comment = { fg = colors.comment },
      Folded = { fg = colors.color4, bg = colors.background },
      FoldColumn = { fg = colors.color4, bg = colors.background },
      LineNr = { fg = colors.linenr, bg = colors.background },
      ...
      CursorColumn = { bg = colors.color1 , fg=colors.color1},
      ...
      Number = { fg = colors.color3 , bg=colors.color16},
      ...
      NvimTreeNormalNC = { fg = colors.foreground, bg = colors.color16 },
      ...
      NvimTreeFolderIcon = { fg = colors.color16, bg = colors.background },
      NvimTreeFolderName = { fg = colors.color16 },
      NvimTreeOpenedFolderName = { fg = colors.color2 },
      NvimTreeEmptyFolderName = { fg = colors.color16 },
      NvimTreeStatusLineNC = { fg = colors.background, bg = colors.color2 }, -- khi con tro không ở trong menu nvim-trê
